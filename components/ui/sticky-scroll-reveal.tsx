  ...
  return (
    ...
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              ...
              <motion.p
                ...
                className="text-kg mt-10 max-w-sm text-neutral-700 dark:text-slate-300"
              >
                {item.description}
              </motion.p>
            </div>
      ...
      <div
        ...
        className={cn(
          "sticky top-10 hidden h-[600px] w-[700px] overflow-hidden rounded-md bg-white dark:bg-neutral-900 lg:block mr-16 lg:mr-32",
          contentClassName,
        )}
      >
